/* http://prismjs.com/download.html?themes=prism&languages=markup+clike+javascript+jsx&plugins=line-highlight+line-numbers */
var _self =
...
!(function () {
  ...
  function n(e, n, i) {
    for (
      ...
      (m.textContent = Array(h - u + 2).join(' \n')),
        (m.className = (i || '') + ' line-highlight'),
        t(e, 'line-numbers') ||
          (m.setAttribute('data-start', u), h > u && m.setAttribute('data-end', h)),
        (m.style.top = (u - l - 1) * c + 'px'),
        t(e, 'line-numbers') ? e.appendChild(m) : (e.querySelector('code') || e).appendChild(m);
    }
  }
  function i() {
