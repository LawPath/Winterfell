...
// const Winterfell = ({schema,panelId,currentQuestionId,onFocus})=> {
//   const [formComponent, setFormComponent] = useState(null);
//   const [panelHistory, setPanelHistory] = useState([]);
//   const [schema, setSchema] = useState(_.extend(
//     {
//       classes: {},
//       formPanels: [],
//       questionPanels: [],
...
//       let questionPanels = schema.questionSets
//         .map((qs) =>
//           qs.questions.map((q2) => {
//             return {
...
//         if (currentQuestionId === qs.questionId) {
//           return qs.panel;
//         }
//       });
//       if (!questionPanel) {
...
//               (e) => e.conditionalQuestionId === currentQuestionId,
//             ).questionId
//           ) {
//             return qs.panel;
//           }
//         });
//       }
//       if (currentPanel.panelId !== questionPanel.panel.panelId) {
//         setCurrentPanel(questionPanel.panel);
//         setPanelHistory(panelHistory.concat([questionPanel.panel.panelId]))
//         onFocus(currentQuestionId);
//       }
//     }
//     onRender();
//   }, [schema,action, questionAnswers,currentQuestionId]) 
...
//       .value();
//     console.log('This fuction is called: handleAnswerChange at index: ');
//     this.setState({
...
//           <TestHook value={this.state.schema} />
//           <QuestionPanel
